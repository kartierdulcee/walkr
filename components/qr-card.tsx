...
export function QrCard() {
  ...
  return (
    <div className="section-card p-4 sm:p-5">
      ...
      <div className="mt-3 inline-block rounded-2xl bg-white p-2 shadow-soft">
        <QRCode value={link} bgColor="#ffffff" fgColor="#4f2f16" size={120} style={{ height: 'auto', maxWidth: '100%', width: '100%' }} />
      </div>
    </div>
  );
}
